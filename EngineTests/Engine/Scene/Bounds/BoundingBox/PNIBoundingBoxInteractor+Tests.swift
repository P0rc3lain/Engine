...
class PNIBoundingBoxInteractorTests: XCTestCase {
    ...
    func testAABBFromOOBB() throws {
        ...
        let corners = interactor.corners(aabb)
        XCTAssertEqual(corners[0], [0, 0, 0])
        XCTAssertEqual(corners[1], [2, 0, 0])
        XCTAssertEqual(corners[2], [0, 0, 3])
        XCTAssertEqual(corners[3], [2, 0, 3])
        XCTAssertEqual(corners[4], [0, 4, 0])
        XCTAssertEqual(corners[5], [2, 4, 0])
        XCTAssertEqual(corners[6], [0, 4, 3])
