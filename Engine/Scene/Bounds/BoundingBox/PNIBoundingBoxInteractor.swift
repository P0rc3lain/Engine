...
public struct PNIBoundingBoxInteractor: PNBoundingBoxInteractor {
    ...
    public func isEqual(_ lhs: PNBoundingBox, _ rhs: PNBoundingBox) -> Bool {
        boundInteractor.isEqual(bound(lhs), bound(rhs))
    }
    public func multiply(_ lhs: simd_float4x4, _ rhs: PNBoundingBox) -> PNBoundingBox {
        PNBoundingBox(cornersLower: lhs * rhs.cornersLower,
                      cornersUpper: lhs * rhs.cornersUpper)
    }
    public func bound(_ boundingBox: PNBoundingBox) -> PNBound {
    ...
    public func merge(_ lhs: PNBoundingBox, _ rhs: PNBoundingBox) -> PNBoundingBox {
        from(bound: boundInteractor.merge(bound(lhs), rhs: bound(rhs)))
    }
    public func overlap(_ lhs: PNBoundingBox, _ rhs: PNBoundingBox) -> Bool {
        boundInteractor.overlap(bound(lhs), bound(rhs))
    }
    public func from(bound: PNBound) -> PNBoundingBox {
    ...
    public func from(_ corners: [simd_float3]) -> PNBoundingBox {
    ...
    public func from(inverseProjection: simd_float4x4) -> PNBoundingBox {
    ...
    public static var `default`: PNBoundingBoxInteractor {
